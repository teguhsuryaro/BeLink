# 02 - Mobile Bottom Navigation

## Tujuan
Membuat navigasi bawah untuk tampilan mobile yang responsif dan menarik.

---

## Buat File

**BUAT FILE**: `src/components/layout/MobileNav.tsx`
...
- [ ] File `src/components/layout/MobileNav.tsx` sudah ada
- [ ] Tab navigasi berjumlah 5: Beranda, Pesan, Riwayat, Notifikasi, Profil
- [ ] Hanya tampil di layar `< md` (mobile)

---

**Selesai? Lanjut ke `03-desktop-navigation.md`**
